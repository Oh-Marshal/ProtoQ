...
//
// 必须在使用其他业务操作码之前调用。
func Negotiate(ctx context.Context, client *Client, opts ...NegotiateOption) (*NegotiateResponse, error) {
	// 1. 构建协商请求
...
func MustNegotiate(ctx context.Context, client *Client, opts ...NegotiateOption) *NegotiateResponse {
...
func StartHeartbeat(client *Client, cfg *HeartbeatLoopConfig) (stop func()) {
	if cfg == nil {
